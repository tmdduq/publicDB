...
open class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun initParam() {
        ...
        param!!.saveUrlJsp = resources.getString(R.string.saveUrlJsp)
        param!!.imageUploadUrlJsp = resources.getString(R.string.imageUploadUrlJsp)
        param!!.phoneName = ""
        param!!.phoneNo = "";
    }
    ...
    private fun attachClickListner(){
        ...
        binding.facilityPnameValue.addTextChangedListener(object : TextWatcher{
            ...
            override fun afterTextChanged(p0: Editable?) {
                ...
                param!!.getAllpName().iterator().forEach {
                    if(it==string) {
...
//        if(((Spinner)findViewById(R.id.facility_district_type_value)).getSelectedItemPosition() < 1) check.append("[구역 미선택]구역을 선택하세요.\n");
    ...
    inner class TranferData() : AsyncTask<Unit,Unit,Array<String>>(){
        override fun doInBackground(vararg p0: Unit?): Array<String>? {
            ...
            imageResult = HTTP(param).DoFileUpload(imageFilepath)
            valuesResult = HTTP(param).DoValuesUpload("")
